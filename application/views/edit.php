...
<?php echo form_open('home/edit/'.$data['id'], "class='form-horizontal'"); ?>
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="form-field-1" placeholder="Name" name="name" class="col-xs-10 col-sm-5" value="<?php echo $data['name']; ?>">
		</div>
	</div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <select name="parent_id" value="<?php echo $data['parent_id']; ?>">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="text" id="form-field-2" placeholder="Place Of Stay" class="col-xs-10 col-sm-5" name="place_of_stay" value="<?php echo $data['place_of_stay']; ?>">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-9">
			<input type="number" id="form-field-3" placeholder="Mobile No" class="col-xs-10 col-sm-5" name="contact_no" value="<?php echo $data['contact_no']; ?>">
		</div>
	</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="text" id="form-field-5" placeholder="Email" class="col-xs-10 col-sm-5" name="email" value="<?php echo $data['email']; ?>">
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="number" id="form-field-6" placeholder="Alternate mobile No" class="col-xs-10 col-sm-5" max-length="10" name="alt_contact_no" value="<?php echo $data['alt_contact_no']; ?>">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <textarea name='spouse_details' id="form-field-6" class="col-xs-10 col-sm-5"><?php echo $data['spouse_details']; ?></textarea>
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        echo $data['gender'] == "male" ? "checked" : "";
        ?> /> Male
        <input type="radio" name="gender" value="female" <?php
        echo $data['gender'] == "female" ? "checked" : "";
        ?>/> Female
        <input type="radio" name="gender" value="other" <?php
        echo $data['gender'] == "other" ? "checked" : "";
        ?>/> Other
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        echo $data['alive_status'] == 1 ? "checked" : "";
        ?>/> Alive
        <input type="radio" name="alive_status" value=0  <?php
        echo $data['alive_status'] == 0 ? "checked" : "";
        ?>/> Died
    </div>
</div>
<div class="form-group">
