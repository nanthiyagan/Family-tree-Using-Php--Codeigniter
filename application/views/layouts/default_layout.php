...
<head>
                ...
                <meta charset="utf-8" />
                <title> Family Tree<?php echo $title;?></title>
	...
	<div id="navbar" class="navbar navbar-default">
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				<a href="/codeigniter/home" class="navbar-brand">
					<small>
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						<li>
							...
							<a href="/codeigniter/home">Home</a>
						</li>
						<?php if($title != 'Home') :?>
			...
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120">
									Copyright � timetoschools.com All rights reserved.
					</span>
				</div>
			</div>
		</div>
